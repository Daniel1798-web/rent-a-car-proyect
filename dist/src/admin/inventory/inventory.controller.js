...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: "Agregar o actualizar inventario de un modelo de auto en una sucursal" }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [create_inventory_dto_1.CreateInventoryDto]),
    __metadata("design:returntype", void 0)
], InventoryController.prototype, "upsert", null);
__decorate([
    (0, common_1.Get)("availability"),
    (0, roles_decorator_1.Roles)("employee"),
    (0, swagger_1.ApiBearerAuth)("access-token"),
    (0, swagger_1.ApiOperation)({ summary: "Consultar disponibilidad de autos" }),
