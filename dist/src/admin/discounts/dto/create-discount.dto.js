...
__decorate([
    (0, swagger_1.ApiProperty)({ description: "Código del descuento (ej: 'SUMMER10')" }),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], CreateDiscountDto.prototype, "code", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: "Porcentaje de descuento (ej: 10 = 10%)" }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: "Fecha de inicio del descuento (YYYY-MM-DD)", required: false }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsDateString)(),
    __metadata("design:type", String)
], CreateDiscountDto.prototype, "startDate", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: "Fecha de fin del descuento (YYYY-MM-DD)", required: false }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsDateString)(),
    __metadata("design:type", String)
